...
class NoteContentWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        fun updateAppWidget(
            ...
            val views = RemoteViews(context.packageName, R.layout.widget_note_content)

            if (noteId == -1L) {
                views.setTextViewText(R.id.widget_note_title_text, context.getString(R.string.app_name))
                views.setTextViewText(R.id.widget_note_content_text, "Please select a note")
            ...
            views.setOnClickPendingIntent(R.id.widget_note_content_text, pendingIntent)
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                if (note != null) {
                    ...
                    val contentText = if (note.isLocked) {
                        ...
                        note.content.ifEmpty { context.getString(R.string.no_content) }
                    }
                    
                    views.setTextViewText(R.id.widget_note_title_text, titleText)
                    views.setTextViewText(R.id.widget_note_content_text, contentText)
                    ...
                    views.setTextViewText(R.id.widget_note_content_text, "")
                }
